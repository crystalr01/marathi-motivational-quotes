...
public class UploadKalam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_kalam);
    ...
    private void uploadImage() {
        ...
        filepath = storageReference.child("prctice").child(finalimg+"jpg");
        final UploadTask uploadTask = filepath.putBytes(finalimg);
        uploadTask.addOnCompleteListener(UploadKalam.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onComplete(@NonNull @NotNull Task<UploadTask.TaskSnapshot> task) {
                if (task.isSuccessful()){
                    ...
                    pd.dismiss();
                    Toast.makeText(UploadKalam.this, "Something went wrong...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void uploadData() {
        ...
        reference = reference.child("prctice");
        ...
        NoticeData2 noticeData = new NoticeData2(title,downloadUrl,date,time,uniqkey);

        reference.child(uniqkey).setValue(noticeData).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                pd.dismiss();
                Toast.makeText(UploadKalam.this, "Upload success!", Toast.LENGTH_SHORT).show();
